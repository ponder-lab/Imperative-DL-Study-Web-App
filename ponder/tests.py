...
class AddCategorizationFormTests(TestCase):
    ...
    def test_categorizer_not_null(self):
        form = CategorizationForm(category_text='', category_description='', cause_text='', cause_description='',fix_text='',fix_description='',symptom_text='', \
            symptom_description='',sha='0000000', data={}, user=None)
