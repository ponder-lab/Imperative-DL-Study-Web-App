...
urlpatterns=[
    ...
    path('', views.CategorizationsListView.as_view(), name='categorizations_changelist'),
    path('categorizations/add/', views.CategorizationsCreateView.as_view(), name='categorizations_add'),
